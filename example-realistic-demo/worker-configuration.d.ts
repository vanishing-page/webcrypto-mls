/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=example-realistic-demo/wrangler.jsonc example-realistic-demo/worker-configuration.d.ts` (hash: b87dc9dd60ba75a732f8343070308ae9)
