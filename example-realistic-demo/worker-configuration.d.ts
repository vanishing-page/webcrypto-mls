/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=example-realistic-demo/wrangler.jsonc example-realistic-demo/worker-configuration.d.ts` (hash: b2d047d2b40eec8fc1561bc8c03d2117)
