...
for (const cs of Object.keys(ciphersuites)) {
    test('Multiple joins at once ' + cs, async (t) => {
        await multipleJoinsAtOnce(t, cs as CiphersuiteName)
    })
}

async function multipleJoinsAtOnce (t: any, cipherSuite: CiphersuiteName) {
