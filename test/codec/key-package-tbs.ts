...
test('keyPackageTBS roundtrip minimal', (t) => {
    const tbs = {
    ...
    roundtrip(t, tbs, 'should roundtrip minimal key package TBS')
})

test('keyPackageTBS roundtrip nontrivial', (t) => {
    const tbs = {
        version: 'mls10' as const,
        cipherSuite: 'MLS_256_XWING_AES256GCM_SHA512_Ed25519' as const,
    ...
    roundtrip(t, tbs, 'should roundtrip nontrivial key package TBS')
})
