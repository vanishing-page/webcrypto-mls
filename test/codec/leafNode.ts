...
import type { LeafNode } from '../../src/leafNode.js'
import { encodeLeafNode, decodeLeafNode } from '../../src/leafNode.js'
...
test('LeafNode roundtrip minimal', (t) => {
    roundtrip(t, minimalLeafNode, 'should roundtrip minimal LeafNode')
})

test('LeafNode roundtrip nontrivial', (t) => {
    roundtrip(t, nontrivialLeafNode, 'should roundtrip nontrivial LeafNode')
})
