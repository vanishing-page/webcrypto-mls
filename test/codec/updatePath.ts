...
import type { UpdatePath } from '../../src/updatePath.js'
import { decodeUpdatePath, encodeUpdatePath } from '../../src/updatePath.js'

test('UpdatePath minimal roundtrip', (t) => {
    ...
    t.deepEqual(decoded, minimal, 'should roundtrip minimal')
})

test('UpdatePath non-trivial roundtrip', (t) => {
    ...
    const decoded = decodeUpdatePath(encoded, 0)![0]
    t.deepEqual(decoded, nonTrivial, 'should roundtrip non-trivial')
})
