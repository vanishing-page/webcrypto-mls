...
import type { KeyPackage } from '../../src/keyPackage.js'
import { encodeKeyPackage, decodeKeyPackage } from '../../src/keyPackage.js'
...
test('KeyPackage roundtrip minimal', (t) => {
    roundtrip(t, minimalKeyPackage, 'should roundtrip minimal KeyPackage')
})

test('KeyPackage roundtrip nontrivial', (t) => {
    roundtrip(t, nontrivialKeyPackage, 'should roundtrip nontrivial KeyPackage')
})
