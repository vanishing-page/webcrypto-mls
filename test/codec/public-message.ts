...
test('PublicMessage roundtrip member', (t) => {
    ...
    }, 'should roundtrip member')
})

test('PublicMessage roundtrip external', (t) => {
    roundtrip(t, {
        content: {
            contentType: 'commit',
