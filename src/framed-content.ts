...
import { encodeProtocolVersion } from './protocol-version.js'
import type {
    Sender,
    SenderExternal,
    SenderMember,
...
export function signFramedContentTBS (signKey:SignatureSecretKey, tbs:FramedContentTBS, s:Signature):Promise<Uint8Array> {
