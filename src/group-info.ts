...
import { decodeGroupContext, encodeGroupContext, extractEpochSecret } from './group-context.js'
import { CodecError } from './mls-error.js'
import type { RatchetTree } from './ratchet-tree.js'
import { decodeRatchetTree } from './ratchet-tree.js'
...
export async function signGroupInfo (tbs:GroupInfoTBS, privateKey:SignatureSecretKey, s:Signature):Promise<GroupInfo> {
